...
//         // Horizontal chart continued
//         samples = data.samples.filter(subject => subject.id == selected_id[0]);
//         console.log(samples)
...
//     // selected_id = d3.select("#selDataset").text();
// }
